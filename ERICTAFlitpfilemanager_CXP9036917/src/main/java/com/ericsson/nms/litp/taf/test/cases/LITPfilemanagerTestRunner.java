...
public class LITPfilemanagerTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPfilemanagerTestRunner.class);
    ...
    @TestId(id = "CXP9036917-1", title = "Upgrade ERIClitpfilemanager rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitpfilemanagerRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("filemanager");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9036917-2", title = "Run python test cases for ERIClitpfilemanager package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitpfilemanagerTests() {
     ...
     * @PRE Execution of test {@link #runERIClitpfilemanagerTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9036917-3", title = "Parse xml outputs from python tests")
